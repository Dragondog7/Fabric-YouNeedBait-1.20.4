...
public class ModConfiguredFeatures {
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, SALT_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldSaltOres,5 ));
    }

    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, new Identifier(YouNeedBait.MOD_ID, name));
    }
