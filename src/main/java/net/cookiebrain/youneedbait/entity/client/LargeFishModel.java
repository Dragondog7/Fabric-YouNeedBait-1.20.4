...
public class LargeFishModel<T extends LargeFishEntity> extends SinglePartEntityModel<T> {
    private final ModelPart largefish;
    public LargeFishModel(ModelPart root) {
        this.largefish = root.getChild("largefish");
    }
    public static TexturedModelData getTexturedModelData() {
        ModelData modelData = new ModelData();
        ModelPartData modelPartData = modelData.getRoot();
        ModelPartData LargeFish = modelPartData.addChild("largefish", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

        ModelPartData LowerJaw = LargeFish.addChild("LowerJaw", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData UpperJaw = LargeFish.addChild("UpperJaw", ModelPartBuilder.create().uv(18, 12).cuboid(1.5F, -8.5F, -19.0F, 0.0F, 2.0F, 2.0F, new Dilation(0.0F))
        ...
        ModelPartData TailFin = LargeFish.addChild("TailFin", ModelPartBuilder.create().uv(17, 17).cuboid(-0.5F, -9.5F, 15.0F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData TopFin = LargeFish.addChild("TopFin", ModelPartBuilder.create().uv(10, 7).cuboid(0.0F, -14.0F, 9.0F, 0.0F, 2.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData AnalFin = LargeFish.addChild("AnalFin", ModelPartBuilder.create().uv(0, 0).cuboid(0.0F, -5.5F, 10.0F, 0.0F, 2.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData BackFinRight = LargeFish.addChild("BackFinRight", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData BackFinLeft = LargeFish.addChild("BackFinLeft", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData FrontFinLeft = LargeFish.addChild("FrontFinLeft", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData FrontFinRight = LargeFish.addChild("FrontFinRight", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData FrontTailBody = LargeFish.addChild("FrontTailBody", ModelPartBuilder.create().uv(0, 10).cuboid(-1.5F, -9.5F, 11.0F, 3.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData Neck = LargeFish.addChild("Neck", ModelPartBuilder.create().uv(0, 0).cuboid(-1.5F, -9.5F, -17.0F, 3.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData Body = LargeFish.addChild("Body", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -10.0F, -11.0F, 4.0F, 5.0F, 22.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        return TexturedModelData.of(modelData, 64, 64);
    }
    @Override
    public void setAngles(LargeFishEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        //This HAS to be called first
        this.getPart().traverse().forEach(ModelPart::resetTransform);

        this.animateMovement(ModAnimations.LARGEFISH_SWIM,limbSwing,limbSwingAmount, 2f, 2.5f);
        this.updateAnimation(entity.idleAnimationState,ModAnimations.LARGEFISH_IDLE,ageInTicks,1f);
    }
    @Override
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
        largefish.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
    }
